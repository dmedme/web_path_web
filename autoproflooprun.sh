...
# about 1 hour. The scenario is called, profloop.
#
...
# 2. Remove the existing 'scenario execution' profloop.
# 3. Re-extract or reset the data that will be re-used
#    -  MALE and FEMALE
#    -  Combine them
# 4. Create a new 'scenario execution' for profloop, and assign it to
...
#         /home/bench/fluline/work/profloop.1/timout.html
